...
fibonacciNumbers.unshift('hi', 'yes');
fibonacciNumbers.push('hello', 'bye');
...
const newArray = ['blue', 'black', 'yellow', 'purple', 'white'];
...
const emptyArray = [];
emptyArray.push('computer', 'monitor', 'tv');
emptyArray.unshift('car', 'motorcycle');
...
const sliceArr = students.slice(3,10);
console.log(sliceArr);
for(let i = 3; i < sliceArr.length; i++){
  console.log(sliceArr[i]);
  console.log(students[i]);
}
